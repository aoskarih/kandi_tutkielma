...
\prof{professori/dosentti/jne Testi}
...
Tuloksia esiteltäessä kannattaa tekstin lisäksi käyttää hyväksi kuvia ja usein myös taulukoita (Ei oikeesti). Kuvateksti tulee kuvan alapuolelle, taulukkoteksti taas taulukon  yläpuolelle.
